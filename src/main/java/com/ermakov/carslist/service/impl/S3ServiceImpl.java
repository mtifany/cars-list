...
public class S3ServiceImpl implements S3Service {
  ...
  public String putFile(String fileName, String fileExtension, byte[] fileBytes) {
    ...
    try {
      ...
      log.info("New content [{}] was added", fileAwsKey);
      return fileAwsKey;
    } catch (S3Exception e) {
      log.error("Error during put s3 object with key [{}], message: [{}]",
  ...
  public void deleteFile(String fileName) {
    ...
    try {
      ...
      log.info("Content [{}] was successfully deleted", fileName);
    } catch (S3Exception e) {
      log.error("Error during deletion of s3 object with key [{}], message: [{}]",
